...
data = json.load(
    open(r'backend-sdk/json-olddata/general.json', encoding='utf-8'))
n = len(data)
assn = []
club = []
...
cm = web.find_element_by_xpath(
    """//*[@id="root"]/main/nav/div[2]/a[3]/div/p""").click()
for i in range(0, n):
    ...
    if data[i]["CAT"] == 'assn':
        web.find_element_by_xpath(
            """//*[@id="root"]/main/div/section/section/div[2]/div[1]/div/div/select""").click()
        web.find_element_by_xpath(
            """//*[@id="root"]/main/div/section/section/div[2]/div[1]/div/div/select/option[3]""").click()
    if data[i]["CAT"] == "club":
        web.find_element_by_xpath(
            """//*[@id="root"]/main/div/section/section/div[2]/div[1]/div/div/select""").click()
        web.find_element_by_xpath(
            """//*[@id="root"]/main/div/section/section/div[2]/div[1]/div/div/select/option[2]""").click()

    cd = web.find_element_by_xpath(
        """//*[@id="root"]/main/div/section/section/div[2]/div[2]/div[1]/div/input""")
    cd.send_keys(cid)
